...
class BarChartSample6Third extends StatelessWidget {
  ...
  final List<List<double>> data = distancesForEachDistance[2]; //first ko lagi
  
  BarChartSample6Third({Key? key}) : super(key: key) {
 ...
 Widget leftTitles(double value, TitleMeta meta) {
  ...
  List<String> intervals = durationsForEachDistance[2]; 
