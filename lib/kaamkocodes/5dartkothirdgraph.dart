...
import 'package:taskes/kaamkocodes/barchartkocode3.dart';
...
class ChartToggleWidget_third extends StatefulWidget {
  @override
  _ChartToggleWidget_thirdState createState() => _ChartToggleWidget_thirdState();
}
class _ChartToggleWidget_thirdState extends State<ChartToggleWidget_third> {
      ...
      children: [
        Stack(
          ...
          children: [
            ...
            if (isLoading)
              BarChartSample6Third(), // Show the chart
