...
import 'package:taskes/kaamkocodes/barchartkocode.dart';
...
class _ChartToggleWidgetState extends State<ChartToggleWidget> {
  ...
  bool barhcartstatus = barchart_stauts_load;
  bool mainfilestatus = frommainfile_reload_status;
      ...
      children: [
        Stack(
          ...
          children: [
            ...
            if (isLoading)
              BarChartSample6(), // Show the chart
